    ...
    public void insertData(View vw){
        ...
        try {
            ...
            if(edtxtName.getText().length() == 0 || edtxtPosition.getText().length() == 0 ||
                ...
                addContent.put("NAME", name);
                addContent.put("POSITION", position);
                addContent.put("EMPLOYEE_NUM", employeeNumber);
                addContent.put("WAGE", wage);

                employeeDatabaseHelper.insertElement(db, addContent);
                txtvwResult.setText("Element has been added successfully.");
            ...
            txtvwResult.setText("This database was not found.");
        }
